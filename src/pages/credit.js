...
import { description } from "../components/styles.module.css";
  ...
  return (
    <Layout>
      <main className={description}>
        ...
        <a href="https://www.gatsbyjs.com/">Gatsby!</a> I referenced{" "}
        <a href="https://get.foundation/index.html">Foundation CSS</a> for the
        component styling of my buttons.
        <img
          alt="Gatsby G Logo"
        ...
        >
          Home button icons created by iconmas - Flaticon
        </a>
        <a href="https://www.flaticon.com/free-icons/heart" title="heart icons">
          Heart icons created by iconmas - Flaticon
        </a>
        <a
